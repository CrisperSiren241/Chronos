...
public class PlayerMovementAdvanced : MonoBehaviour
{
    ...
    public float lowJumpMultiplier = 2f; // Падение после короткого прыжка
    ...
    private void Update()
    {
        ...
        else if (!grounded && rb.linearVelocity.y > 0 && !Input.GetKey(jumpKey))
        {
    ...
    private void StateHandler()
    {
        ...
        else
        {
            ...
            if (moveSpeed < airMinSpeed) desiredMoveSpeed = airMinSpeed;
    ...
    private void MovePlayer()
    {
        ...
        // Убираем поворот персонажа в направлении камеры
        ...
        if (grounded)
        {
            ...
            float targetVelocity = (state == MovementState.sprinting) ? 1f : (OnSlope() ? 0.5f : 0.5f);
            animator.SetFloat("Velocity", Mathf.Lerp(animator.GetFloat("Velocity"), targetVelocity, Time.deltaTime * 5f));
            animator.SetBool("isFalling", false);
        }
